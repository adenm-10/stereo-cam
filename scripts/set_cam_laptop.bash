...
v4l2-ctl -d /dev/video6 --set-ctrl=brightness=0
v4l2-ctl -d /dev/video6 --set-ctrl=contrast=45
v4l2-ctl -d /dev/video6 --set-ctrl=saturation=70
v4l2-ctl -d /dev/video6 --set-ctrl=hue=0
v4l2-ctl -d /dev/video6 --set-ctrl=white_balance_automatic=1
v4l2-ctl -d /dev/video6 --set-ctrl=gamma=90
v4l2-ctl -d /dev/video6 --set-ctrl=gain=5
v4l2-ctl -d /dev/video6 --set-ctrl=power_line_frequency=1
# v4l2-ctl -d /dev/video6 --set-ctrl=white_balance_temperature=2800
v4l2-ctl -d /dev/video6 --set-ctrl=sharpness=6
v4l2-ctl -d /dev/video6 --set-ctrl=backlight_compensation=5
v4l2-ctl -d /dev/video6 --set-ctrl=auto_exposure=1
v4l2-ctl -d /dev/video6 --set-ctrl=exposure_time_absolute=15

...
v4l2-ctl -d /dev/video0 --set-ctrl=brightness=-3
v4l2-ctl -d /dev/video0 --set-ctrl=contrast=26
...
v4l2-ctl -d /dev/video0 --set-ctrl=gamma=146
...
v4l2-ctl -d /dev/video4 --set-ctrl=brightness=-3
v4l2-ctl -d /dev/video4 --set-ctrl=contrast=26
...
v4l2-ctl -d /dev/video4 --set-ctrl=gamma=146
